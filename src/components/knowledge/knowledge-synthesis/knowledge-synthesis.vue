        ...
        <div class="info">
          <div class="header_info">
            ...
            <!-- <div class="right_info">
                            ...
                            <div class="right_5 info_style">
                                <p class="large">20</p>
                                <p class="small">归档阶段</p>
                            </div>
                            <div class="right_2 info_style">
                                <p class="large">6</p>
                                <p class="small">整改阶段 </p>
                            </div>
                        </div> -->
          </div>
          <div class="main_info">
              ...
              <div class="table_header_info">
                ...
                <div class="header_info_btn">
                  ...
                  <input
                    type="button"
                    value="新增"
                    onclick="javascrtpt:window.location.href='#javascript'"
                  />
                  <input
                    type="button"
                    value="导入"
...
.header_info_btn input:nth-child(4) {
  width: 96px;
}
